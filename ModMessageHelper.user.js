...
`,
  },
  {
    ...
    templateBody: `**Use of AI for content while its use is banned:**  \nThe use of AI as a source for content on Stack Overflow is currently banned. Please see the Meta Stack Overflow question "[Temporary policy: ChatGPT is banned](https://meta.stackoverflow.com/q/421831)". It is not permitted for you to use AI to create content on Stack Overflow during this ban.
